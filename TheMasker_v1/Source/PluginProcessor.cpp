...
//==============================================================================
const juce::String TheMasker_v1AudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool TheMasker_v1AudioProcessor::acceptsMidi() const
{
...
bool TheMasker_v1AudioProcessor::producesMidi() const
{
...
bool TheMasker_v1AudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double TheMasker_v1AudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int TheMasker_v1AudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int TheMasker_v1AudioProcessor::getCurrentProgram()
{
    return 0;
}

void TheMasker_v1AudioProcessor::setCurrentProgram (int index)
{
}

const juce::String TheMasker_v1AudioProcessor::getProgramName (int index)
{
    return {};
}

void TheMasker_v1AudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
//==============================================================================
bool TheMasker_v1AudioProcessor::hasEditor() const
{
